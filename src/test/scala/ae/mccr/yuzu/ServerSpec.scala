...
//    (response.body must contain("Test Instance"))
    ...
    def test_list = get("/list") {
      ...
      (response.body must contain("<a href=\\\'/list/?offset=0\\\' class=\\\'btn"
                      + " btn-default disabled\\\'>&lt;&lt;</a>")) and
      (response.body must contain("<a href=\\\'/list/?offset=20\\\' class=\\\'btn"
                      + " btn-default disabled\\\'>&gt;&gt;</a>")) and
    ...
    def test_nt = get("/data/example.nt") {
        (response.body must contain("<http://localhost:8080/data/example>")) and
        (response.body must contain("Beispiel")) and
        (response.body must contain("<http://dbpedia.org/resource/Example>")) 
    }
